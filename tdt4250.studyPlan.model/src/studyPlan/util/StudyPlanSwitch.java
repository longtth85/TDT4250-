...
public class StudyPlanSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StudyPlanPackage.COURSE_IN_PROGRAM: {
				CourseInProgram courseInProgram = (CourseInProgram)theEObject;
				T result = caseCourseInProgram(courseInProgram);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StudyPlanPackage.PROGRAMME_START: {
				ProgrammeStart programmeStart = (ProgrammeStart)theEObject;
				T result = caseProgrammeStart(programmeStart);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StudyPlanPackage.PROGRAMME_LEVEL: {
				ProgrammeLevel programmeLevel = (ProgrammeLevel)theEObject;
				T result = caseProgrammeLevel(programmeLevel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Course In Program</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Course In Program</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCourseInProgram(CourseInProgram object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Programme Start</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Programme Start</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseProgrammeStart(ProgrammeStart object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Programme Level</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Programme Level</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseProgrammeLevel(ProgrammeLevel object) {
		return null;
	}
